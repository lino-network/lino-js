declare namespace Keys {
    const KVSTOREKEYS: {
        ...
        AccountInfoSubStore: string;
        AccountBankSubStore: string;
        AccountMetaSubStore: string;
        AccountRewardSubStore: string;
        AccountPendingCoinDaySubStore: string;
        AccountGrantPubKeySubStore: string;
        AccountAllGrantPubKeys: string;
        DeveloperSubStore: string;
        DeveloperListSubStore: string;
        TimeEventListSubStore: string;
        GlobalMetaSubStore: string;
        InflationPoolSubStore: string;
        ConsumptionMetaSubStore: string;
        TpsSubStore: string;
        LinoStakeStatSubStore: string;
        GlobalTimeSubStore: string;
        InfraProviderSubStore: string;
        InfraListSubStore: string;
        PostInfoSubStore: string;
        PostMetaSubStore: string;
        PostReportOrUpvoteSubStore: string;
        PostCommentSubStore: string;
        PostViewSubStore: string;
        NextProposalIDSubStore: string;
        OngoingProposalSubStore: string;
        ExpiredProposalSubStore: string;
        ValidatorSubStore: string;
        ValidatorListSubStore: string;
        DelegationSubStore: string;
        VoterSubStore: string;
        VoteSubStore: string;
        ReferenceListSubStore: string;
        DelegateeSubStore: string;
        AllocationParamSubStore: string;
        InfraInternalAllocationParamSubStore: string;
        DeveloperParamSubStore: string;
        VoteParamSubStore: string;
        ProposalParamSubStore: string;
        ValidatorParamSubStore: string;
        CoinDayParamSubStore: string;
        BandwidthParamSubStore: string;
        AccountParamSubStore: string;
        PostParamSubStore: string;
        ReputationParamSubStore: string;
        ReputationSubStore: string;
    };
    ...
    function getReputationParamKey(): string;
