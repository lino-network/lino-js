...
export declare function signWithSha256(msg: any, privKeyHex: string): string;
export declare function verifyWithSha256(msg: any, pubKeyHex: string, signature: string): boolean;
