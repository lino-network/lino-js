...
class Query {
    ...
    getAllGrantPubKeys(username) {
        const AccountKVStoreKey = Keys$1.KVSTOREKEYS.AccountKVStoreKey;
        return this._transport.querySubspace(Keys$1.getGrantPubKeyPrefix(username), AccountKVStoreKey);
    }
    /**
    ...
    getAllRelationships(username) {
        const AccountKVStoreKey = Keys$1.KVSTOREKEYS.AccountKVStoreKey;
        return this._transport.querySubspace(Keys$1.getRelationshipPrefix(username), AccountKVStoreKey);
    }
    /**
    ...
    getAllFollowerMeta(username) {
        const AccountKVStoreKey = Keys$1.KVSTOREKEYS.AccountKVStoreKey;
        return this._transport.querySubspace(Keys$1.getFollowerPrefix(username), AccountKVStoreKey);
    }
    /**
    ...
    getAllFollowingMeta(username) {
        const AccountKVStoreKey = Keys$1.KVSTOREKEYS.AccountKVStoreKey;
        return this._transport.querySubspace(Keys$1.getFollowingPrefix(username), AccountKVStoreKey);
    }
    // post related query
    /**
    ...
    getAllPosts(author) {
        ...
        return this._transport.querySubspace(Keys$1.getPostInfoPrefix(author), PostKVStoreKey);
    }
    /**
    ...
    getPostAllComments(author, postID) {
        const PostKVStoreKey = Keys$1.KVSTOREKEYS.PostKVStoreKey;
        const Permlink = Keys$1.getPermlink(author, postID);
        return this._transport.querySubspace(Keys$1.getPostCommentPrefix(Permlink), PostKVStoreKey);
    }
    /**
    ...
    getPostAllViews(author, postID) {
        const PostKVStoreKey = Keys$1.KVSTOREKEYS.PostKVStoreKey;
        const Permlink = Keys$1.getPermlink(author, postID);
        return this._transport.querySubspace(Keys$1.getPostViewPrefix(Permlink), PostKVStoreKey);
    }
    /**
    ...
    getPostAllDonations(author, postID) {
        const PostKVStoreKey = Keys$1.KVSTOREKEYS.PostKVStoreKey;
        const Permlink = Keys$1.getPermlink(author, postID);
        return this._transport.querySubspace(Keys$1.getPostDonationsPrefix(Permlink), PostKVStoreKey);
    }
    /**
    ...
    getPostAllReportOrUpvotes(author, postID) {
        const PostKVStoreKey = Keys$1.KVSTOREKEYS.PostKVStoreKey;
        const Permlink = Keys$1.getPermlink(author, postID);
        return this._transport.querySubspace(Keys$1.getPostReportOrUpvotePrefix(Permlink), PostKVStoreKey);
    }
    /**
    ...
    getPostAllLikes(author, postID) {
        const PostKVStoreKey = Keys$1.KVSTOREKEYS.PostKVStoreKey;
        const Permlink = Keys$1.getPermlink(author, postID);
        return this._transport.querySubspace(Keys$1.getPostLikePrefix(Permlink), PostKVStoreKey);
    }
    /**
    ...
    getVoterAllDelegation(voter) {
        const VoteKVStoreKey = Keys$1.KVSTOREKEYS.VoteKVStoreKey;
        return this._transport.querySubspace(Keys$1.getDelegationPrefix(voter), VoteKVStoreKey);
    }
    /**
    ...
    getDelegatorAllDelegation(delegatorName) {
        const VoteKVStoreKey = Keys$1.KVSTOREKEYS.VoteKVStoreKey;
        return this._transport.querySubspace(Keys$1.getDelegateePrefix(delegatorName), VoteKVStoreKey);
    }
    /**
    ...
    getProposalAllVotes(proposalID) {
        const VoteKVStoreKey = Keys$1.KVSTOREKEYS.VoteKVStoreKey;
        return this._transport.querySubspace(Keys$1.getVotePrefix(proposalID), VoteKVStoreKey);
    }
...
class Transport {
    ...
    querySubspace(subspace, storeName) {
        // transport: get path and key for ABCIQuery and return result
        // get transport's node and do ABCIQuery
        // rpc client do rpc call
        // check resp
...
export { LINO, index as UTILS, isEvaluateOfContentValueParam, isGlobalAllocationParam, isInfraInternalAllocationParam, isVoteParam, isProposalParam, isDeveloperParam, isValidatorParam, isCoinDayParam, isBandwidthParam, isAccountParam, isPostParam, isChangeParamProposalValue, isContentCensorshipProposalValue, isProtocolUpgradeProposalValue, DETAILTYPE, Transport, BroadCastErrorEnum, BroadcastError, genPrivKeyHex, pubKeyFromPrivate, isValidUsername, isKeyMatch, derivePrivKey };
