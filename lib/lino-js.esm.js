...
class Query {
    ...
    getPendingCoinDayQueue(username) {
        const AccountKVStoreKey = Keys$1.KVSTOREKEYS.AccountKVStoreKey;
        return this._transport.query(Keys$1.getAccountPendingCoinDayQueueKey(username), AccountKVStoreKey);
    }
    /**
     ...
     * @param username: user name
     */
    getUserReputationMeta(username) {
        const repKVStoreKey = Keys$1.KVSTOREKEYS.ReputationKVStoreKey;
        return this._transport.query(Keys$1.getUserReputationMetaKey(username), repKVStoreKey);
    }
